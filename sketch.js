...
let perguntas = [
  {
    pergunta: "Qual é a escolha mais inteligente para se locomover na cidade e ajudar o meio ambiente?",
    opcoes: ["Usar o carro para todo lugar", "Andar de ônibus, metrô, bicicleta ou a pé", "Sempre pedir um táxi", "Ficar em casa para não precisar se mover"],
    respostaCorreta: 1, // Andar de ônibus, metrô, bicicleta ou a pé
    dica: "Pense em como você pode diminuir a fumaça no ar e ainda fazer bem para a sua saúde!"
  },
  {
    pergunta: "Para que a agricultura continue produzindo alimentos saudáveis por muitos anos, o que é fundamental?",
    opcoes: ["Usar muito agrotóxico", "Plantar só um tipo de comida sempre", "Cuidar do solo e revezar as plantações", "Desmatar para ter mais espaço para plantar"],
    respostaCorreta: 2, // Cuidar do solo e revezar as plantações
    dica: "A terra precisa de 'descanso' e 'comida' variada para continuar nos dando seus frutos."
  },
  {
    pergunta: "Qual é o superpoder das árvores que mais nos ajuda, tanto no campo quanto na cidade?",
    opcoes: ["Elas fazem barulho", "Elas produzem muito lixo", "Elas limpam o ar e controlam a temperatura", "Elas chamam muitos insetos"],
    respostaCorreta: 2, // Elas limpam o ar e controlam a temperatura
    dica: "Imagine um dia quente de verão... O que te faz sentir mais fresco e respirar melhor?"
  },
  {
    pergunta: "Como podemos ser heróis na cozinha e evitar que muita comida seja jogada fora?",
    opcoes: ["Comprando em excesso e deixando estragar", "Planejando as refeições e aproveitando as sobras", "Jogando fora o que não for perfeito", "Pedindo muita comida por delivery todos os dias"],
    respostaCorreta: 1, // Planejando as refeições e aproveitando as sobras
    dica: "Com um pouco de organização e criatividade, nada se perde, tudo se transforma... em uma nova refeição!"
  }
];
...
function draw() {
  ...
  text("FEITO POR LARA GIOVANA 1B COLÉGIO ESTADUAL IDALIA ROCHA", width - 250, height - 20);
}
